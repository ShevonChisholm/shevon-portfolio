      ...
      switch (project.slug) {
          ...
          return [
            {
              ...
              description: 'Comprehensive system for uploading and managing streaming content through AWS integration'
            },
            {
              title: 'Subscription Management',
              description: 'Full Stripe integration for managing subscription plans and user payments'
            },
            {
              title: 'Analytics Dashboard',
              description: 'Detailed user engagement metrics and content performance analytics'
            },
            {
              title: 'User Management',
              description: 'Advanced tools for user role management and access control'
            }
          ];
          ...
          return [
            {
              ...
              description: 'Integrated blog functionality for sharing educational insights and experiences'
            },
            {
              title: 'Resource Management',
              description: 'Organized system for showcasing teaching materials and resources'
            },
            {
              title: 'Responsive Design',
              description: 'Optimized viewing experience across all devices and screen sizes'
            },
            {
              title: 'Portfolio Showcase',
              description: 'Elegant display of teaching philosophy and professional achievements'
            }
          ];
        case 'travaguz':
          return [
            {
              ...
              description: 'Integrated travel package booking and reservation management'
            },
            {
              title: 'Interactive Gallery',
              description: 'Rich media showcase of travel destinations and experiences'
            },
            {
              title: 'Package Customization',
              description: 'Flexible system for customizing travel packages and itineraries'
            },
            {
        ...
        case 'caribbean-world-explorer':
          return [
            ...
            {
              title: 'Search & Filter',
              description: 'Advanced search functionality for finding specific destinations'
            },
            {
              title: 'User Reviews',
              description: 'Integrated review and rating system for travel experiences'
            }
          ];
        default:
          return [
